import{j as e,u as l,m as o}from"./index-B7-TwNZn.js";const i=({label:r,value:a,isHighScore:s})=>{const{isDark:t}=l();return e.jsxs(o.div,{initial:{scale:.9,opacity:0},animate:{scale:1,opacity:1},className:`relative overflow-hidden rounded-xl p-6
